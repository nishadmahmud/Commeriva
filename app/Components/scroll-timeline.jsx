            ...
            <>
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(158deg,rgba(105, 212, 255, 1) 0%, rgba(0, 7, 196, 0.75) 50%, rgba(105, 212, 255, 1) 100%)`,
                  boxShadow: `
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle,rgba(10, 85, 247, 1) 0%, rgba(148, 164, 233, 1) 100%)",
                    boxShadow: `
                      0 0 5px 4px rgba(174, 194, 238, 1),
                      0 0 20px 8px rgba(99, 102, 241, 0.4),
                      0 0 30px 15px rgba(34, 211, 238, 0.2)
                    `,
                  }}
                  animate={{
                    scale: [1, 1.3, 1],
              ...
              return (
                ...
                >
                  ...
                  >
                    <motion.div
                      className={cn(
                        "w-6 h-6 rounded-full  bg-background flex items-center justify-center ",
                        index <= activeIndex
                  ...
                  <motion.div
                    className={cn(getCardClasses(index), "mt-12 lg:mt-0 rounded-4xl")}
                  ...
                  >
                    <div className="bg-[linear-gradient(158deg,rgba(105,212,255,1)_0%,rgba(0,7,196,0.75)_50%,rgba(105,212,255,1)_100%)] border border-blue-200 rounded-4xl text-white">
