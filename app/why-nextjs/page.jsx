    ...
    <div onMouseMove={handleMouseMove} className="min-h-screen bg-white dark:bg-neutral-950 relative overflow-hidden">
      ...
      <div className="flex mt-10 justify-between md:flex-row-reverse items-center flex-col-reverse">
          ...
          <div className="max-w-xl w-full">
             {features2.map((feature, index) => (
              <motion.div
                ...
                custom={index}
                className="group md:p-6 p-4 border-b last:border-b-0 border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-neutral-800/50 transition-colors duration-200"
              >
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                custom={index}
                whileHover="hover"
                className="group relative p-8 rounded-2xl border-2 border-gray-100 dark:border-white/10 hover:border-teal-600 dark:hover:border-teal-400 transition-all duration-300 hover:shadow-xl bg-white dark:bg-neutral-900"
              >
          ...
          >
            {companies.map((company, index) => (
              <motion.div
                ...
                custom={index}
                whileHover="hover"
                className="group text-center p-6 border border-gray-200 dark:border-white/10 rounded-xl hover:border-gray-400 dark:hover:border-white/20 hover:shadow-lg transition-all bg-white dark:bg-neutral-900"
              >
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                custom={index}
                whileHover="hover"
                className="text-center p-8 border-2 border-gray-200 dark:border-white/10 rounded-2xl hover:border-gray-400 dark:hover:border-white/20 hover:shadow-lg transition-all group bg-white dark:bg-neutral-900"
              >
        ...
        <motion.div 
          ...
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }}
          className="text-center border-2 border-gray-200 dark:border-white/10 rounded-3xl p-16 hover:border-gray-400 dark:hover:border-white/20 transition-colors bg-white dark:bg-neutral-900"
        >
